...
public class WeatherForecastMainVO implements Serializable{


	private static final long serialVersionUID = -2987029022228552903L;
	...
	public String toString() {
		return "WeatherForecastMainVO [temp=" + temp + ", temp_min=" + temp_min + ", temp_max=" + temp_max
